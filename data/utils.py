...
def load_datasets(num_instances=1000000, pertubation=0, seed=None):
    ...
    sea = SuddenDriftSEA(variant=1, drift_variant=2, drift_instance=500000, noise=0.2, seed=seed)
    hyperplane = Hyperplane(n_features=20, n_drift_features=10, mag_change=0.001, noise_percentage=0.2, seed=seed)
